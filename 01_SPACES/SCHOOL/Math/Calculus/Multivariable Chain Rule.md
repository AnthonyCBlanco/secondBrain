...
\end{gather}
$$
We may encounter many differ partial derivatives because just how $g(x)$ is a function of $f(x)$ in Calculus 1. Here we have $x$ as a function of $t$ and $y$ as a function of $s$ & $t$, then $z$ as a function of $x$ & $y$ 
